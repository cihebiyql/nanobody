...
CAMPAIGNS = {
    "c2_new4220": {
        "expected": 16880,
        "remote": (
            "pvrig_c2_new6220_dualreceptor_2seed_v1_20260723_bxcpu_results/"
            "batch_4220"
        ),
    },
    "c2_new2000": {
...
LOCAL_ROOT = pathlib.Path(
    os.environ.get(
        ...
        "/mnt/d/work/抗体/node1/pvrig_c2_new6220_dualseed_bxcpu_incremental_spool_20260723",
    )
)
NODE1_ROOT = os.environ.get(
    "PVRIG_BXCPU_SYNC_NODE1_ROOT",
    "/data1/qlyu/projects/pvrig_c2_new6220_dualreceptor_2seed_docking_results_v1_20260723",
)
