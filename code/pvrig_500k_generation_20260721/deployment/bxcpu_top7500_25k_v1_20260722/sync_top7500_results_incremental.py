...
CAMPAIGNS = {
    "top7500_25k": {
        "expected": 25000,
        "remote": "pvrig_priority_top7500_dualreceptor_multiseed_handoff_v3_20260722_bxcpu_results",
    },
}
LOCAL_ROOT = pathlib.Path(
    os.environ.get(
        "PVRIG_BXCPU_SYNC_LOCAL_ROOT",
        "/mnt/d/work/抗体/node1/pvrig_top7500_25k_bxcpu_incremental_spool_20260722",
    )
)
NODE1_ROOT = os.environ.get(
    "PVRIG_BXCPU_SYNC_NODE1_ROOT",
    "/data1/qlyu/projects/pvrig_priority_top7500_dualreceptor_multiseed_docking_results_v1_20260722",
)
