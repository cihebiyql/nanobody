...
import node1_contact_gradient_calibration_v1 as mod  # noqa: E402
...
class CalibrationLauncherTests(unittest.TestCase):
    ...
    def test_bundle_v1_import_dependencies_are_exact_and_required(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            fixture = Fixture(temporary)
            for label in ("base_trainer_v1", "base_trainer_v1_5", "base_residue_model_v1"):
                self.assertIn("/residue_v1/src/", str(fixture.context.artifacts[label].path))
