...
runs one full1507, outer-fold-0, one-epoch smoke per lane, reads only the first
...
MATRIX_SCHEMA = "pvrig_v6_residue_v2_contact_gradient_calibration_matrix_v1"
MATRIX_STATUS = "FROZEN_OPEN_ONLY_PREPRODUCTION_CALIBRATION_MATRIX"
BOOTSTRAP_SCHEMA = "pvrig_v6_residue_v2_contact_gradient_calibration_bootstrap_v1"
TERMINAL_SCHEMA = "pvrig_v6_residue_v2_contact_gradient_calibration_terminal_v1"
...
DEFAULT_MATRIX = SCRIPT.with_name("CONTACT_GRADIENT_CALIBRATION_MATRIX_V1.json")
...
def publish_content_addressed(runtime_root: Path, staging: Path) -> tuple[Path, dict[str, Any]]:
    ...
    current = {
        "schema_version": "pvrig_v6_residue_v2_contact_gradient_calibration_current_v1",
