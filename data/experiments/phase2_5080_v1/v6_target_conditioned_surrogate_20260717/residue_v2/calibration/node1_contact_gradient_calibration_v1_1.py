...
MATRIX_SCHEMA = "pvrig_v6_residue_v2_contact_gradient_calibration_matrix_v1_1"
MATRIX_STATUS = "FROZEN_OPEN_ONLY_PREPRODUCTION_CALIBRATION_MATRIX"
BOOTSTRAP_SCHEMA = "pvrig_v6_residue_v2_contact_gradient_calibration_bootstrap_v1_1"
TERMINAL_SCHEMA = "pvrig_v6_residue_v2_contact_gradient_calibration_terminal_v1_1"
...
DEFAULT_MATRIX = SCRIPT.with_name("CONTACT_GRADIENT_CALIBRATION_MATRIX_V1_1.json")
...
def publish_content_addressed(runtime_root: Path, staging: Path) -> tuple[Path, dict[str, Any]]:
    ...
    current = {
        "schema_version": "pvrig_v6_residue_v2_contact_gradient_calibration_current_v1_1",
