# Node1 Residue V2 open-only contact-gradient calibration V1.1

## V1 失败保留与 V1.1 修复

V1 因 bundle 遗漏 `build_residue_graph_cache_v2.py` 和 `domain_balance_v2.py` 而 fail-closed；V1 文件、matrix、runtime 和失败证据保持原样。V1.1 使用全新 bundle/runtime，并对 trainer 的完整 repo-local import 闭包逐文件绑定 SHA256。
...
- bundle：`/data1/qlyu/projects/pvrig_v6_residue_v2_contact_gradient_calibration_bundle_v1_1_20260718`
- runtime：`/data1/qlyu/projects/pvrig_v6_residue_v2_contact_gradient_calibration_v1_1_20260718`
...
```text
residue_v2/calibration/node1_contact_gradient_calibration_v1_1.py
residue_v2/calibration/CONTACT_GRADIENT_CALIBRATION_MATRIX_V1_1.json
...
```bash
B=/data1/qlyu/projects/pvrig_v6_residue_v2_contact_gradient_calibration_bundle_v1_1_20260718
PY=/data1/qlyu/software/envs/pvrig-v6-tc/bin/python
L=$B/residue_v2/calibration/node1_contact_gradient_calibration_v1_1.py
M=$B/residue_v2/calibration/CONTACT_GRADIENT_CALIBRATION_MATRIX_V1_1.json
