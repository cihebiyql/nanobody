#!/usr/bin/env python3
"""Independently collect V1.4 outer-fold predictions and bootstrap by parent."""
...
SCHEMA_VERSION = "pvrig_v6_residue_v1_4_oof_collector"
CLAIM_BOUNDARY = (
...
def validate_implementation_freeze(path: Path, root: Path, governance_path: Path) -> dict[str, str]:
    ...
    payload = json.loads(path.read_text(encoding="utf-8"))
    require(payload.get("schema_version") == "pvrig_v6_residue_v1_4_implementation_freeze", "collector_implementation_freeze_schema_invalid")
...
def collect(args: argparse.Namespace) -> dict[str, Any]:
    ...
    oof_path = args.output_dir / "residue_v1_4_nested_oof_predictions.tsv"
