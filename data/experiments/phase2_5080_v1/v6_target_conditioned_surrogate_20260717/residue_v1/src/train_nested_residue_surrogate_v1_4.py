#!/usr/bin/env python3
"""V1.4 production trainer with nested whole-parent selection and resumability."""
...
SCHEMA_VERSION = "pvrig_v6_nested_residue_surrogate_v1_4"
INNER_FOLD_COUNT = 5
...
def validate_implementation_freeze(freeze_path: Path, root: Path, governance_path: Path) -> dict[str, str]:
    ...
    require(payload.get("schema_version") == "pvrig_v6_residue_v1_4_implementation_freeze", "implementation_freeze_schema_invalid")
