#!/usr/bin/env python3
"""V1.3 production trainer with nested whole-parent selection and resumability."""
...
SCHEMA_VERSION = "pvrig_v6_nested_residue_surrogate_v1_3"
INNER_FOLD_COUNT = 5
...
def validate_governance_amendment(path: Path) -> dict[str, Any]:
    ...
    require((payload.get("frozen_implementation") or {}).get("promotion_gate") == EXACT_PROMOTION_GATE, "governance_promotion_gate_invalid")
    return payload
...
def validate_implementation_freeze(freeze_path: Path, root: Path, governance_path: Path) -> dict[str, str]:
    ...
    require(payload.get("schema_version") == "pvrig_v6_residue_v1_3_implementation_freeze", "implementation_freeze_schema_invalid")
