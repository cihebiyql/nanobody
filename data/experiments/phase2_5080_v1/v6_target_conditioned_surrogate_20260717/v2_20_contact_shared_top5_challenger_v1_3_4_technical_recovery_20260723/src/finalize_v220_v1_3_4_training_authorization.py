#!/usr/bin/env python3
"""Render a gated V1.3.4 training launcher after preflight and approval.
...
PREFLIGHT_STATUS = "PASS_NODE1_V220_V1_3_4_FIVE_FOLD_SHARED_CALIBRATION_LOAD_ONLY_NO_TRAINING"
APPROVAL_STATUS = "APPROVE_V220_V1_3_4_TECHNICAL_RECOVERY_TRAINING"
FREEZE_STATUS = "FROZEN_V1_3_4_IMPLEMENTATION_PENDING_INDEPENDENT_REVIEW_AND_NODE1_PREFLIGHT"
...
def finalize(args: argparse.Namespace) -> dict[str, Any]:
    ...
    require(
        freeze.get("implementation_hashes", {}).get("PREREGISTRATION_PHASE1_TECHNICAL_RECOVERY_V1_3_4.json") == prereg_sha,
    ...
    template = package_root / "launchers/run_phase1_core_fold_pair_node1_v1_3_4.template.sh"
    ...
    replacements = {
        "__V220_FINALIZATION_STATE__": "FINALIZED_V220_V1_3_4",
    ...
    authorization = {
        "schema_version": "pvrig.v220.v1_3_4_final_training_authorization.v1",
        "status": "FINAL_AUTHORIZED_V220_V1_3_4_TEN_FRESH_ARMS",
    ...
    auth_path = args.output_dir / "FINAL_TRAINING_AUTHORIZATION_V1_3_4.json"
