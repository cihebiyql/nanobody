...
prereg_path=root/'PREREGISTRATION_PHASE1_CORE_V1_1.json'
...
"$PYTHON_BIN" "$ROOT/src/replay_v213_b0_oof_v1.py" \
  --preregistration "$ROOT/PREREGISTRATION_PHASE1_CORE_V1_1.json" \
...
terminal={
 'schema_version':'pvrig_v220_phase1_pretraining_terminal_v1_1',
