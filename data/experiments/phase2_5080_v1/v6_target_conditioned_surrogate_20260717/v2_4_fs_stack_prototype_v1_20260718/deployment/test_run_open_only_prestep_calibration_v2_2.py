...
SPEC = importlib.util.spec_from_file_location("calibration_v2_2", HERE / "run_open_only_prestep_calibration_v2_2.py")
MODULE = importlib.util.module_from_spec(SPEC)
assert SPEC and SPEC.loader
SPEC.loader.exec_module(MODULE)


class CalibrationCommandV22Tests(unittest.TestCase):
