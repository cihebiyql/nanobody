...
SPEC = importlib.util.spec_from_file_location("calibration_v2_2_1", HERE / "run_open_only_prestep_calibration_v2_2_1.py")
...
class CalibrationCommandV221Tests(unittest.TestCase):
    ...
    def test_pending_manifest_status_matches_v2_2_launcher_contract(self) -> None:
        self.assertEqual(
            ...
            "PREFREEZE_V2_2_1_ADAPTIVE_MULTI_SEED_CALIBRATION_PENDING_DO_NOT_START",
        )
