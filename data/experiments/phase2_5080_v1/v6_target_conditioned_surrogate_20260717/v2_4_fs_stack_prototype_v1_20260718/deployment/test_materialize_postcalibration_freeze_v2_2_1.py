...
from . import materialize_postcalibration_freeze_v2_2_1 as mod
from . import node1_v2_4_outer_development_launcher_v2_2_1 as launcher
...
class PostCalibrationFreezeTests(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.prefreeze = self.bundle / "V2_4_NODE1_PREFREEZE_MANIFEST_V2_2_1.json"
        self.receipt = self.bundle / "CALIBRATION_RECEIPT.json"
        self.ready = self.bundle / "V2_4_NODE1_READY_MANIFEST_V2_2_1.json"
        self.freeze = self.bundle / "IMPLEMENTATION_FREEZE_V2_4_ADAPTIVE_V2_2_1.json"
        ...
        for label in (
            ...
            "v2_2_1_status_supersession_audit", "postcalibration_materializer_test",
            "v2_migration_test",
        ):
