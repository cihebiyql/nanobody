...
from . import materialize_postcalibration_freeze_v2 as mod
from . import node1_v2_4_outer_development_launcher_v2 as launcher
...
class PostCalibrationFreezeTests(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.prefreeze = self.bundle / "V2_4_NODE1_PREFREEZE_MANIFEST_V2.json"
        self.receipt = self.bundle / "CALIBRATION_RECEIPT.json"
        self.ready = self.bundle / "V2_4_NODE1_READY_MANIFEST_V2.json"
        self.freeze = self.bundle / "IMPLEMENTATION_FREEZE_V2_4_ADAPTIVE_V2.json"

        files = {}
        for label in ("trainer", "calibration_trainer", "calibration_runner", "outer_split_0", "vhh_graph_cache_npz"):
