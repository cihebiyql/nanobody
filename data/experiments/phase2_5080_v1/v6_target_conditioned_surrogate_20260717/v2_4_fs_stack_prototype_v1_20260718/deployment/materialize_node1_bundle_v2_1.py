#!/usr/bin/env python3
"""Stage the superseding V2.1 adaptive-multiseed Node1 bundle."""
...
MANIFEST_NAME = "V2_4_NODE1_PREFREEZE_MANIFEST_V2_1.json"
...
def materialize(manifest_path: pathlib.Path, readme_path: pathlib.Path, output_root: pathlib.Path) -> dict[str, Any]:
    ...
    receipt = {
        "schema_version": "pvrig_v6_residue_v2_4_node1_staged_bundle_v2_1_adaptive_multiseed_multibatch",
        "status": "PASS_NODE1_BUNDLE_V2_1_STAGED_CALIBRATION_PENDING_DO_NOT_EXECUTE_OUTER",
...
if __name__ == "__main__":
    try:
        ...
        print(f"FAIL_V2_4_BUNDLE_V2_1_MATERIALIZATION:{error}", file=os.sys.stderr)
        raise SystemExit(1)
