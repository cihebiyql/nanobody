#!/usr/bin/env python3
"""Build the V2.4 adaptive-multiseed V2 prefreeze manifest.

V2 never accepts the historical V4-H Stage-1 contact tables.  Its formal
...
BUNDLE = "/data1/qlyu/projects/pvrig_v6_residue_v2_4_deployment_bundle_v2_20260718"
RUNTIME = "/data1/qlyu/projects/pvrig_v6_residue_v2_4_four_lane_oof_v2_20260718"
CALIBRATION_RUNTIME = "/data1/qlyu/projects/pvrig_v6_residue_v2_4_calibration_v2_20260718"
...
EXPECTED_V2_IMPLEMENTATION_SHA256 = {
    ...
    "calibration_runner": "baaa47c35d192a9a21d5c43020826d9507a9a475039a26c6bb3bec5a42612ff7",
...
def run(
    *, repo: pathlib.Path, output: pathlib.Path, input_contract: pathlib.Path,
    ...
    specs = {
        ...
        "calibration_runner": (f"{p}/deployment/run_open_only_prestep_calibration_v2.py", f"{BUNDLE}/src/run_open_only_prestep_calibration_v2.py"),
