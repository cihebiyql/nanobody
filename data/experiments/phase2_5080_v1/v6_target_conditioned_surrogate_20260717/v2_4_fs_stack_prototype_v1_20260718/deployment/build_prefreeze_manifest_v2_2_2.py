#!/usr/bin/env python3
"""Build the V2.4 V2.2.2 bundle-receipt-contract technical-supersession manifest.
...
CALIBRATION_RUNTIME = "/data1/qlyu/projects/pvrig_v6_residue_v2_4_calibration_v2_2_2_20260718"
...
MANIFEST_STATUS = "PREFREEZE_V2_2_2_ADAPTIVE_MULTI_SEED_CALIBRATION_PENDING_DO_NOT_START"
...
EXPECTED_V2_IMPLEMENTATION_SHA256 = {
    ...
    "deployment_launcher": "786f89497ac82c41a675bd7084a46d0cf94b0b3969b23f4113e485766880b6f3",
    "deployment_launcher_test": "b711a4c93cd8d00a75aa99bdc8d9eaf0702affa3960a1b186356f1d32e5c7590",
    "calibration_runner": "0113018f1966f446086e7f812a426f48fc68df643e833026119147a11e252565",
    "calibration_runner_test": "812616e47676345090afa8f0101472c48ab41692dc5499e37be4a2ae51fdaeb7",
    "postcalibration_materializer": "d894ec890ec83ee275a38c12a770d3595756989fc1eaf8d3252d9834c0d6398d",
    "postcalibration_materializer_test": "538db94d86a8c3b3fdb5f8288fa88b83bbd7e9eeee1146170c5c96d4f7929dce",
    "v2_migration_test": "ff72c786585f83fcc51d735ec348e0f99e19ba71439c4ec46b6c9007e56dd742",
    "bundle_materializer": "7048561107e479c5de5e9e7c8e0e9a77ee709467e9eabd3b191f008264142b37",
}
...
def compose_payload(
    ...
    return {
        ...
        "manifest_generation": "V2_2_2_BUNDLE_RECEIPT_CONTRACT_CORRECTED",
        ...
        "technical_supersession": {
            ...
            "scope": (
                "V2.2.2 immutable bundle-receipt contract closure preserving all V2.2.1 "
                "nonnumeric corrections while adding exact campaign claim, trainer-result claim, "
                "and bundle-revision emission and validation at the staged delivery boundary"
            ),
            ...
            "bundle_revision_scope": (
                "bundle-receipt contract correction plus complete hash closure across builder, "
                "runner, launcher, postcalibration materializer, bundle materializer, and tests"
            ),
            "bundle_revision_numeric_method_changes": 0,
            "bundle_revision_audit_artifact_label": "v2_2_2_bundle_receipt_supersession_audit",
            "bundle_revision_audit_sha256": artifacts["v2_2_2_bundle_receipt_supersession_audit"]["sha256"],
        },
        "artifacts": artifacts,
        "trainer": {
        ...
        "calibration_contract": {
            "binding_status": "PENDING_V2_2_2_ADAPTIVE_OPEN_ONLY_PRESTEP_CALIBRATION",
        ...
        "pending": ["CALIBRATION_RECEIPT.json", "frozen_lane_contact_weights", "IMPLEMENTATION_FREEZE_V2_4_ADAPTIVE_V2_2_2.json"],
...
def run(
    *, repo: pathlib.Path, output: pathlib.Path, input_contract: pathlib.Path,
    ...
    specs = {
        "prefreeze_builder": (f"{p}/deployment/build_prefreeze_manifest_v2_2_2.py", f"{BUNDLE}/src/build_prefreeze_manifest_v2_2_2.py"),
        ...
        "calibration_runner": (f"{p}/deployment/run_open_only_prestep_calibration_v2_2_2.py", f"{BUNDLE}/src/run_open_only_prestep_calibration_v2_2_2.py"),
        "calibration_runner_test": (f"{p}/deployment/test_run_open_only_prestep_calibration_v2_2_2.py", f"{BUNDLE}/tests/test_run_open_only_prestep_calibration_v2_2_2.py"),
        "deployment_launcher": (f"{p}/deployment/node1_v2_4_outer_development_launcher_v2_2_2.py", f"{BUNDLE}/src/node1_v2_4_outer_development_launcher_v2_2_2.py"),
        "deployment_launcher_test": (f"{p}/deployment/test_node1_v2_4_outer_development_launcher_v2_2_2.py", f"{BUNDLE}/tests/test_node1_v2_4_outer_development_launcher_v2_2_2.py"),
        "postcalibration_materializer": (f"{p}/deployment/materialize_postcalibration_freeze_v2_2_2.py", f"{BUNDLE}/src/materialize_postcalibration_freeze_v2_2_2.py"),
        "postcalibration_materializer_test": (f"{p}/deployment/test_materialize_postcalibration_freeze_v2_2_2.py", f"{BUNDLE}/tests/test_materialize_postcalibration_freeze_v2_2_2.py"),
        "v2_migration_test": (f"{p}/deployment/test_v2_2_claim_supersession.py", f"{BUNDLE}/tests/test_v2_2_claim_supersession.py"),
        "bundle_materializer": (f"{p}/deployment/materialize_node1_bundle_v2_2_2.py", f"{BUNDLE}/src/materialize_node1_bundle_v2_2_2.py"),
        ...
        "v2_2_2_bundle_receipt_supersession_audit": (f"{p}/deployment/V2_2_2_BUNDLE_RECEIPT_SUPERSESSION.json", f"{BUNDLE}/audits/V2_2_2_BUNDLE_RECEIPT_SUPERSESSION.json"),
    ...
    supersession_audit = json.loads(
        pathlib.Path(artifacts["v2_2_2_bundle_receipt_supersession_audit"]["source_path"]).read_text(encoding="utf-8")
    )
    audit_label_map = {
    ...
    require(set(corrected) == set(audit_label_map), "v2_2_2_audit_corrected_artifact_labels")
    for audit_label, artifact_label in audit_label_map.items():
        require(
            corrected[audit_label].get("sha256") == artifacts[artifact_label]["sha256"],
            f"v2_2_2_audit_artifact_sha256:{audit_label}",
        )
    for fold in range(5):
    ...
    require(
        resolved_output == pathlib.Path(BUNDLE) / "V2_4_NODE1_PREFREEZE_MANIFEST_V2_2_2.json"
    ...
    return {"status": "PASS_V2_2_2_ADAPTIVE_PREFREEZE_MANIFEST_MATERIALIZED_CALIBRATION_PENDING", "output": str(output), "sha256": sha256_file(output), "artifact_count": len(artifacts)}
...
def input_preflight(paths: Mapping[str, pathlib.Path]) -> dict[str, Any]:
    ...
    return {
        "schema_version": "pvrig_v2_4_adaptive_prefreeze_input_preflight_v2_2_2",
        "status": "BLOCKED_INPUT_ADAPTIVE_ARTIFACTS_NOT_MATERIALIZED" if missing else "READY_FOR_V2_2_2_MANIFEST_MATERIALIZATION",
        "missing": missing,
        "production_authorized": False,
    }
...
if __name__ == "__main__":
    try:
        ...
        print(f"FAIL_V2_2_2_ADAPTIVE_PREFREEZE_MANIFEST:{error}", file=os.sys.stderr)
        raise SystemExit(1)
