#!/usr/bin/env python3
"""Stage the V2.2.1 status-constant technical-supersession Node1 bundle."""
...
import node1_v2_4_outer_development_launcher_v2_2_1 as deployment  # noqa: E402


PENDING_STATUS = "PREFREEZE_V2_2_1_ADAPTIVE_MULTI_SEED_CALIBRATION_PENDING_DO_NOT_START"
MANIFEST_NAME = "V2_4_NODE1_PREFREEZE_MANIFEST_V2_2_1.json"
...
def materialize(manifest_path: pathlib.Path, readme_path: pathlib.Path, output_root: pathlib.Path) -> dict[str, Any]:
    ...
    required = {
        ...
        "v2_2_1_status_supersession_audit",
    ...
    receipt = {
        "schema_version": "pvrig_v6_residue_v2_4_node1_staged_bundle_v2_2_1_status_constant_corrected",
        "status": "PASS_NODE1_BUNDLE_V2_2_1_STAGED_CALIBRATION_PENDING_DO_NOT_EXECUTE_OUTER",
        ...
        "next_permitted_action": (
            "Deploy to the exact V2.2.1 bundle_root, validate all Node1 artifacts, then run the "
...
if __name__ == "__main__":
    try:
        ...
        print(f"FAIL_V2_4_BUNDLE_V2_2_1_MATERIALIZATION:{error}", file=os.sys.stderr)
        raise SystemExit(1)
