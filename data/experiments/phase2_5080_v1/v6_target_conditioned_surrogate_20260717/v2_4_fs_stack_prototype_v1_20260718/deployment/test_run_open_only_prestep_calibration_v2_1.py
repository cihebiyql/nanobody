...
SPEC = importlib.util.spec_from_file_location("calibration_v2_1", HERE / "run_open_only_prestep_calibration_v2_1.py")
MODULE = importlib.util.module_from_spec(SPEC)
assert SPEC and SPEC.loader
SPEC.loader.exec_module(MODULE)


class CalibrationCommandV21Tests(unittest.TestCase):
