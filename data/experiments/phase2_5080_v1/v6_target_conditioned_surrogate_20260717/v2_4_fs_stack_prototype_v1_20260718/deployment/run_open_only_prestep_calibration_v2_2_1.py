#!/usr/bin/env python3
"""Run the V2.2.1 status-constant-corrected multibatch calibration.
...
import node1_v2_4_outer_development_launcher_v2_2_1 as deployment
...
CALIBRATION_SCHEMA = (
    ...
    "v2_2_1_status_constant_corrected"
)
CALIBRATION_STATUS = (
    "PASS_OPEN_ONLY_PRESTEP_CONTACT_GRADIENT_CALIBRATION_"
    "V2_4_ADAPTIVE_V2_2_1_STATUS_CONSTANT_CORRECTED"
)
...
def dry_run(manifest_path: pathlib.Path) -> dict[str, Any]:
    ...
    return {
        "schema_version": "pvrig_v6_residue_v2_4_calibration_dry_run_v2_2_1_status_constant_corrected",
        "status": "PASS_V2_2_1_ADAPTIVE_OPEN_ONLY_PRESTEP_CALIBRATION_DRY_RUN_NO_MUTATION",
        "manifest_sha256": deployment.sha256_file(manifest_path),
...
if __name__ == "__main__":
    try:
        ...
        print(f"FAIL_V2_4_ADAPTIVE_V2_2_1_CALIBRATION:{error}", file=os.sys.stderr)
        raise SystemExit(1)
