#!/usr/bin/env python3
"""Build the V2.4 adaptive-multiseed V2.2 claim-aligned prefreeze manifest.
...
BUNDLE = "/data1/qlyu/projects/pvrig_v6_residue_v2_4_deployment_bundle_v2_2_20260718"
RUNTIME = "/data1/qlyu/projects/pvrig_v6_residue_v2_4_four_lane_oof_v2_2_20260718"
CALIBRATION_RUNTIME = "/data1/qlyu/projects/pvrig_v6_residue_v2_4_calibration_v2_2_20260718"
...
MANIFEST_STATUS = "PREFREEZE_V2_2_ADAPTIVE_MULTI_SEED_CALIBRATION_PENDING_DO_NOT_START"
...
EXPECTED_V2_IMPLEMENTATION_SHA256 = {
    ...
    "deployment_launcher": "e7af0a8f22b06fba04e69504253a65903b5a7acb3abbcbae769b52d49a625456",
    "calibration_runner": "1af55b94dee9fd993286ec7b37ad2d162b781eea91a28abcc937014584f69fe8",
    "calibration_runner_test": "cd205aa3499b52ce0d95852406d7aec1d4e6bae4e2bf45c3abcd408c5f613620",
    "postcalibration_materializer": "6bbe4438c7c5a855b159033e4780819dac562c1470922f66a6fdf4587a746f72",
    "postcalibration_materializer_test": "c568daeaf27b28ae5ccf179e05937e2e276f72c1c3b015da9197084eac12a119",
    "v2_migration_test": "ff72c786585f83fcc51d735ec348e0f99e19ba71439c4ec46b6c9007e56dd742",
    "bundle_materializer": "6b58d5bfaba96bc8ec222dc3e45f8db69f532880ca0289674676954de105804e",
}
...
def run(
    *, repo: pathlib.Path, output: pathlib.Path, input_contract: pathlib.Path,
    ...
    specs = {
        ...
        "calibration_runner": (f"{p}/deployment/run_open_only_prestep_calibration_v2_2.py", f"{BUNDLE}/src/run_open_only_prestep_calibration_v2_2.py"),
        "calibration_runner_test": (f"{p}/deployment/test_run_open_only_prestep_calibration_v2_2.py", f"{BUNDLE}/tests/test_run_open_only_prestep_calibration_v2_2.py"),
        "deployment_launcher": (f"{p}/deployment/node1_v2_4_outer_development_launcher_v2_2.py", f"{BUNDLE}/src/node1_v2_4_outer_development_launcher_v2_2.py"),
        "postcalibration_materializer": (f"{p}/deployment/materialize_postcalibration_freeze_v2_2.py", f"{BUNDLE}/src/materialize_postcalibration_freeze_v2_2.py"),
        "postcalibration_materializer_test": (f"{p}/deployment/test_materialize_postcalibration_freeze_v2_2.py", f"{BUNDLE}/tests/test_materialize_postcalibration_freeze_v2_2.py"),
        "v2_migration_test": (f"{p}/deployment/test_v2_2_claim_supersession.py", f"{BUNDLE}/tests/test_v2_2_claim_supersession.py"),
        "bundle_materializer": (f"{p}/deployment/materialize_node1_bundle_v2_2.py", f"{BUNDLE}/src/materialize_node1_bundle_v2_2.py"),
    ...
    require(
        resolved_output == pathlib.Path(BUNDLE) / "V2_4_NODE1_PREFREEZE_MANIFEST_V2_2.json"
...
if __name__ == "__main__":
    try:
        ...
        print(f"FAIL_V2_2_ADAPTIVE_PREFREEZE_MANIFEST:{error}", file=os.sys.stderr)
        raise SystemExit(1)
