...
from . import build_prefreeze_manifest_v2_2_1 as builder
from . import materialize_node1_bundle_v2_2_1 as bundle
from . import materialize_postcalibration_freeze_v2_2_1 as postcal
from . import node1_v2_4_outer_development_launcher_v2_2_1 as launcher
from . import run_open_only_prestep_calibration_v2_2_1 as runner


class V221CanonicalClosureTests(unittest.TestCase):
    ...
    def test_v2_2_1_canonical_filenames_close(self) -> None:
        self.assertEqual(bundle.MANIFEST_NAME, "V2_4_NODE1_PREFREEZE_MANIFEST_V2_2_1.json")
        self.assertEqual(launcher.FREEZE_NAME, "IMPLEMENTATION_FREEZE_V2_4_ADAPTIVE_V2_2_1.json")
        source = inspect.getsource(postcal.materialize)
        self.assertIn("V2_4_NODE1_PREFREEZE_MANIFEST_V2_2_1.json", source)
        self.assertIn("V2_4_NODE1_READY_MANIFEST_V2_2_1.json", source)
        self.assertIn("IMPLEMENTATION_FREEZE_V2_4_ADAPTIVE_V2_2_1.json", source)
