#!/usr/bin/env python3
"""Observe V2.4 contact-gradient weights on eight frozen training batches.

This wrapper deliberately imports, but never edits, the immutable V1 base
trainer.  It constructs no optimizer and performs no parameter update.  The
...
SCHEMA_VERSION = "pvrig_v2_4_open_only_prestep_multibatch_gradient_observation_v2"
STATUS = "PASS_OPEN_ONLY_PRESTEP_MULTIBATCH_CONTACT_GRADIENT_LANE_OBSERVATION_V2_4"
SELECTION_RULE = (
