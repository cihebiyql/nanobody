...
from . import observe_v2_4_multibatch_calibration_v2_2 as calibration
from . import train_v2_4_base_split as base
...
class MultiBatchCalibrationTests(unittest.TestCase):
    ...
    def test_v2_2_claim_is_exactly_manifest_aligned_and_not_base_claim(self):
        expected = (
        ...
        self.assertEqual(calibration.CLAIM_BOUNDARY, expected)
        self.assertNotEqual(calibration.CLAIM_BOUNDARY, base.CLAIM_BOUNDARY)
        self.assertEqual(calibration.SUPERSESSION_VERSION, "V2.2_CLAIM_BOUNDARY_ALIGNMENT_ONLY")
