...
def build(args: argparse.Namespace) -> tuple[dict[str, Any], str]:
    ...
    require(
        freeze.get("status") == "FROZEN_V1_3_2_IMPLEMENTATION_PENDING_INDEPENDENT_REVIEW_AND_NODE1_PREFLIGHT",
    ...
    require(prereg_sha == freeze["implementation_hashes"]["PREREGISTRATION_PHASE1_TECHNICAL_RECOVERY_V1_3_2.json"], "prereg_hash")
    ...
    new = parse_test_log(args.v1_3_2_test_log, args.expected_new_tests)
    ...
    payload = {
        "schema_version": "pvrig.v220.v1_3_2_node1_preflight_receipt.v1",
        ...
        "tests": {"legacy": legacy, "v1_3_2": new, "combined_tests_run": 102 + args.expected_new_tests},
        "folds": folds,
        "fold_count": 5,
...
def parser() -> argparse.ArgumentParser:
    ...
    value.add_argument("--v1-3-2-test-log", type=Path, required=True)
