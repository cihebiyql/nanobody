...
[[ "$FINALIZATION_STATE" == "FINALIZED_V220_V1_3_1" ]] || {
...
FINAL_AUTH="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)/FINAL_TRAINING_AUTHORIZATION_V1_3_1.json"
...
assert preflight['status']=='PASS_NODE1_V220_V1_3_1_FIVE_FOLD_SHARED_CALIBRATION_LOAD_ONLY_NO_TRAINING'
...
assert approval['status']=='APPROVE_V220_V1_3_1_TECHNICAL_RECOVERY_TRAINING'
...
assert auth['status']=='FINAL_AUTHORIZED_V220_V1_3_1_TEN_FRESH_ARMS'
...
payload={'schema_version':'pvrig_v220_phase1_core_fold_pair_terminal_v1_3_1','status':'PASS_V220_V1_3_1_C0_C1_FOLD_PAIR','fold_id':fold,'seed':43,'physical_gpu_at_launch':gpu,'shared_calibration_sha256':shared_sha,'results':results}
