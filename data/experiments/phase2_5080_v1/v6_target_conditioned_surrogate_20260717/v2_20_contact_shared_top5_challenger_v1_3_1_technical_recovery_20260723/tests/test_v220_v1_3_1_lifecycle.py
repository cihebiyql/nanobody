...
PREFLIGHT = load("v131_preflight_test", "src/build_v220_v1_3_1_preflight_receipt.py")
FINALIZER = load("v131_finalizer_test", "src/finalize_v220_v1_3_1_training_authorization.py")
HELPER = ROOT / "launchers/run_shared_fold_materialization_once_v1_3_1.sh"
TEMPLATE = ROOT / "launchers/run_phase1_core_fold_pair_node1_v1_3_1.template.sh"
PREREG = ROOT / "PREREGISTRATION_PHASE1_TECHNICAL_RECOVERY_V1_3_1.json"
...
class FiveFoldPreflightReceiptTests(unittest.TestCase):
    def test_five_fold_synthetic_separate_process_evidence_closes_no_training_receipt(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            write_json(freeze, {
                "status": "FROZEN_V1_3_1_IMPLEMENTATION_PENDING_INDEPENDENT_REVIEW_AND_NODE1_PREFLIGHT",
                "training_started": False,
                "implementation_hashes": {"PREREGISTRATION_PHASE1_TECHNICAL_RECOVERY_V1_3_1.json": sha(prereg)},
            })
            ...
            args = argparse.Namespace(
                ...
                preregistration=prereg, legacy_test_log=legacy, v1_3_1_test_log=new,
                expected_new_tests=17, output_receipt=runtime / "NODE1_V1_3_1_PREFLIGHT_RECEIPT.json",
            )
...
class FinalizationLifecycleTests(unittest.TestCase):
    def fixture(self, root: Path):
        ...
        implementation = {
            "PREREGISTRATION_PHASE1_TECHNICAL_RECOVERY_V1_3_1.json": sha(PREREG),
            "launchers/run_phase1_core_fold_pair_node1_v1_3_1.template.sh": sha(TEMPLATE),
            "launchers/run_shared_fold_materialization_once_v1_3_1.sh": sha(HELPER),
            "src/materialize_v220_shared_fold_calibration_v1_3_1.py": sha(ROOT / "src/materialize_v220_shared_fold_calibration_v1_3_1.py"),
            "src/run_v220_contact_shared_fold_v1_3_1.py": sha(ROOT / "src/run_v220_contact_shared_fold_v1_3_1.py"),
        }
        freeze = root / "freeze.json"
        write_json(freeze, {"status": FINALIZER.FREEZE_STATUS, "training_authorized": False, "training_started": False, "implementation_hashes": implementation})
        ...
        args = argparse.Namespace(
            package_root=ROOT, implementation_freeze=freeze, expected_implementation_freeze_sha256=freeze_sha,
    ...
    def test_success_writes_only_launcher_and_false_started_authorization(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            self.assertEqual(sorted(p.name for p in args.output_dir.iterdir()), ["FINAL_TRAINING_AUTHORIZATION_V1_3_1.json", "run_phase1_core_fold_pair_node1_v1_3_1.sh"])
            launcher = args.output_dir / "run_phase1_core_fold_pair_node1_v1_3_1.sh"
...
class SourceClosureTests(unittest.TestCase):
    ...
    def test_preflight_launcher_has_no_arm_training_runner_and_binds_helper_argv(self):
        source = (ROOT / "launchers/run_phase1_preflight_node1_v1_3_1.sh").read_text()
