...
TRUST_SET = PACKAGE / "trust_anchor" / "frozen_real1507_trust_anchors_v1_2"
...
import real1507_role_isolated_trainer_v1_2 as mod
            ...
            for inner_fold in mod.FROZEN_INNER_FOLDS:
                ...
                for seed in mod.FROZEN_ENSEMBLE_SEEDS:
                    ...
                    checkpoint_receipt = write_json(root / f"{prefix}.checkpoint.json", {
                        "schema_version": "pvrig_v2_6_inner_checkpoint_receipt_v1_2",
