...
SCHEMA = "pvrig_v2_6_contact_ablation_cuda_smoke_launcher_v1_4_1"
PYTHON = Path("/data1/qlyu/software/envs/pvrig-v6-tc/bin/python")
VISIBLE = "1,4,5,6"
SMOKE_JOB_SHA256 = "9d153766d518da2d1ce284a92ae515fe48c0aef6455fdf871e9d37070e6669ae"
...
def main() -> int:
    ...
    job_script = args.package_root / "run_contact_ablation_cuda_smoke_v1_4_1.py"
