#!/usr/bin/env python3
"""Run one frozen open-inner frozen eight-epoch open-inner V1.4.2 contact ablation."""
...
SCHEMA = "pvrig_v2_6_contact_ablation_eight_epoch_job_v1_4_2"
CLAIM = (
...
def main() -> int:
    ...
    result = {
        ...
        "status": "PASS_OPEN_INNER_CONTACT_ABLATION_EIGHT_EPOCH",
