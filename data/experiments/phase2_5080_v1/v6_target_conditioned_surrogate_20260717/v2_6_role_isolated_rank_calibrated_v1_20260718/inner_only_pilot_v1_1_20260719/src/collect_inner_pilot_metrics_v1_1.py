...
def validate_job(job_dir: Path, variant: str, seed: int) -> tuple[list[dict[str, str]], dict[str, Any]]:
    ...
    require(training.get("outer_test_truth_access_count") == 0, "training_outer_truth_access")
...
def main() -> int:
    ...
    result = {
        "schema_version": "pvrig_v2_6_inner_only_pilot_metrics_v1_1",
        "status": "PASS_OPEN_INNER_ONLY_PILOT_METRICS",
        "job_id": args.job_id,
