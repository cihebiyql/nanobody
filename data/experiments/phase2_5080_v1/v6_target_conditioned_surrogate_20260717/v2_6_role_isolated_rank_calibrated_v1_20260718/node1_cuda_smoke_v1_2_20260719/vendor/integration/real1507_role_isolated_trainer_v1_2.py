#!/usr/bin/env python3
"""Nonlaunching V2.6 real1507 trainer integration V1.2.
...
SCHEMA_VERSION = "pvrig_v2_6_real1507_role_isolated_trainer_v1_2"
CLAIM_BOUNDARY = (
...
OOF_PREDICTION_RECEIPT_SCHEMA = "pvrig_v2_6_inner_oof_prediction_receipt_v1_2"
...
@dataclass(frozen=True)
class CalibrationFitReceiptV12:
    calibration: Any
    outer_fold: int
    ensemble_id: str
    seeds: tuple[int, ...]
    ...
    def to_payload(self) -> dict[str, Any]:
        ...
        return {
            "schema_version": "pvrig_v2_6_inner_oof_calibration_receipt_v1_2",
...
def fit_fold_local_calibration_from_inner_oof(
    ...
    *,
    ...
    return CalibrationFitReceiptV12(
        calibration=result,
        outer_fold=outer_fold,
...
def fit_fold_local_calibration_from_frozen_oof_artifacts(
    *,
    ...
    for raw_receipt_path in prediction_receipt_paths:
        ...
        require(checkpoint_receipt.get("schema_version") == "pvrig_v2_6_inner_checkpoint_receipt_v1_2", "oof_checkpoint_receipt_schema")
