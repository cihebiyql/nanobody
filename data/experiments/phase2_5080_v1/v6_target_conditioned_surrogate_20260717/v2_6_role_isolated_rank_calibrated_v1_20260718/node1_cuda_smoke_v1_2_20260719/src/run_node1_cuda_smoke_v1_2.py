...
SCHEMA_VERSION="pvrig_v2_6_node1_cuda_bf16_smoke_v1_2"
...
INTEGRATION_TRAINER_SHA="036fb5f1d8b443bc3fd514ae6fe43970af42b6d078c378233f2825550b61d4e4"
...
def module_imports(package_root:Path):
    ...
    integ=importlib.import_module('real1507_role_isolated_trainer_v1_2')
...
def main()->int:
    ...
    lanes={}
    for lane,variant in ((modules[2].LANE_B,'B_CLEAN_TARGET_ATTENTION'),(modules[2].LANE_E,'E_DECOUPLED_CONTACT_DETACHED'),(modules[2].LANE_F,'E_DECOUPLED_CONTACT_SHARED')):
    ...
    result={'schema_version':SCHEMA_VERSION,'status':'PASS','claim_boundary':CLAIM_BOUNDARY,'precision':'bf16','physical_gpu_index':1,'logical_cuda_index':0,
      'cuda_visible_devices':[1],'integration_freeze_sha256':INTEGRATION_FREEZE_SHA,'integration_trainer_sha256':INTEGRATION_TRAINER_SHA,
