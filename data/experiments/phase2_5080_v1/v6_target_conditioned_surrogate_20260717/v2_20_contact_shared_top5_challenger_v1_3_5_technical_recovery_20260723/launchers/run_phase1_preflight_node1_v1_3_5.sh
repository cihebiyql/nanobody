...
NEW_TEST_LAUNCHER="$ROOT/launchers/run_tests_v1_3_5.sh"
RECEIPT_BUILDER="$ROOT/src/build_v220_v1_3_5_preflight_receipt.py"
...
EXPECTED_LEGACY_TEST_LAUNCHER_SHA="c3bae8a57009bb05106c74c3fc0e6d4d614c198e96cea6ad25633a455e5b73e6"
...
assert freeze['status']=='FROZEN_V1_3_5_IMPLEMENTATION_PENDING_INDEPENDENT_REVIEW_AND_NODE1_PREFLIGHT'
...
PYTHON_BIN="$PYTHON_BIN" "$NEW_TEST_LAUNCHER" > "$RUNTIME_ROOT/logs/V1_3_5_TESTS.log" 2>&1
...
"$PYTHON_BIN" "$RECEIPT_BUILDER" \
  ...
  --v1-3-5-test-log "$RUNTIME_ROOT/logs/V1_3_5_TESTS.log" \
  --expected-new-tests "$EXPECTED_NEW_TESTS" \
  --output-receipt "$RUNTIME_ROOT/NODE1_V1_3_5_PREFLIGHT_RECEIPT.json"
