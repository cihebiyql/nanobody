...
SCRIPT = Path(__file__).with_name("reconcile_node1_ssd_deepqc_three_state_tnp_igfold100_v3_1.py")
SPEC = importlib.util.spec_from_file_location("reconcile_v3_1", SCRIPT)
