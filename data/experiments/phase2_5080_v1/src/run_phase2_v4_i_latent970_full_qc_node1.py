#!/usr/bin/env python3
"""Run SSD-only Full-QC for the V4-I latent970 expansion pool on Node1."""
...
ROOT = Path("/data1/qlyu/projects/pvrig_v4_i_latent970_qc_v1_20260718")
POOL = Path("/data1/qlyu/projects/pvrig_v4_i_latent970_pool_v1_20260718")
MANIFEST = POOL / "outputs/latent970_candidates.tsv"
FASTA = POOL / "outputs/latent970_candidates.fasta"
...
def preflight() -> dict[str, Any]:
    ...
    return {
        "schema_version": "pvrig_v4_i_latent970_full_qc_preflight_v1",
...
def publish() -> dict[str, Any]:
    ...
    summary = {
        "schema_version": "pvrig_v4_i_latent970_full_qc_terminal_v1",
        "status": "PASS_LATENT970_FULL_QC_COMPLETE",
