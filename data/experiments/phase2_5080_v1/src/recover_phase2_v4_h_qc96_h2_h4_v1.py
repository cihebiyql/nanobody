...
CANONICAL_RECOVERY_ROOT = Path(
    "/data1/qlyu/projects/pvrig_v4_h_qc96_h2_h4_recovery_v1_20260717"
)
CLAIM = (
...
SELECTION_SEED = "V4_H_QC96_H4_HASH_SELECTION_V1"
...
class Recovery:
    ...
    def run(self) -> dict[str, Any]:
        ...
        audit = {
            "schema_version": "phase2_v4_h_qc96_h2_h4_manifest_recovery_audit_v1",
        ...
        receipt = {
            **audit,
            "schema_version": "phase2_v4_h_qc96_h2_h4_manifest_recovery_receipt_v1",
        ...
        complete = {
            "schema_version": "phase2_v4_h_qc96_h2_h4_manifest_recovery_terminal_v1",
...
def main() -> int:
    ...
    if args.preflight:
        ...
        result = {
            "status": "PASS_V4_H_H2_H4_RECOVERY_PREFLIGHT",
