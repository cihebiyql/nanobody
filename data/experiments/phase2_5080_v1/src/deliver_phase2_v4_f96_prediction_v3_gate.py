...
LOCAL=EXP/"status/pvrig_v4_f96_dual_docking_v1/prediction_v3_gate.receipt.json"
SSH=Path("/mnt/c/Windows/System32/OpenSSH/ssh.exe")
REMOTE="/data/qlyu/projects/pvrig_v4_f96_dual_redocking_v1_20260717_gate/prediction_v3_gate.receipt.json"
...
def publish(payload:dict)->None:
 ...
 command="install -d -m 0755 /data/qlyu/projects/pvrig_v4_f96_dual_redocking_v1_20260717_gate && umask 022 && cat > /data/qlyu/projects/pvrig_v4_f96_dual_redocking_v1_20260717_gate/.prediction.tmp && chmod 0444 /data/qlyu/projects/pvrig_v4_f96_dual_redocking_v1_20260717_gate/.prediction.tmp && mv /data/qlyu/projects/pvrig_v4_f96_dual_redocking_v1_20260717_gate/.prediction.tmp /data/qlyu/projects/pvrig_v4_f96_dual_redocking_v1_20260717_gate/prediction_v3_gate.receipt.json"
