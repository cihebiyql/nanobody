#!/usr/bin/env python3
"""Resumable NanoBodyBuilder2 monomer generation for the V4-H research pool."""
...
def run_candidate(
    ...
    for mode, extra in (("REFINED", []), ("UNREFINED_FALLBACK", ["-u"])):
        ...
        try:
            ...
            payload = {
                "schema_version": "phase2_v4_h_research_monomer_candidate_v1",
                "status": "SUCCESS",
...
def write_progress(root: Path, expected: int) -> dict[str, Any]:
    ...
    payload = {
        "schema_version": "phase2_v4_h_research_monomer_progress_v1",
        "expected": expected,
...
def publish_manifest(root: Path, rows: list[dict[str, str]]) -> dict[str, Any]:
    ...
    payload = {
        "schema_version": "phase2_v4_h_research_monomer_complete_v1",
