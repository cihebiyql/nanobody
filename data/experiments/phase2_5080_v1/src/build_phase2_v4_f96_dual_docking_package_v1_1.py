...
PREREG=EXP/"audits/phase2_v4_f96_dual_docking_v1_1_preregistration.json"
NODE1=SRC/"prepare_phase2_v4_f96_docking_inputs_node1_v1_1.py"
NODE23=SRC/"stage_run_phase2_v4_f96_dual_docking_node23_v1_1.py"
DELIVER=SRC/"deliver_phase2_v4_f96_prediction_v3_gate_v1_1.py"
NODE1_TEMPLATE=SRC/"templates/pvrig_v4_f96_docking_input_node1_waiter_v1_1.sh.in"
NODE23_TEMPLATE=SRC/"templates/pvrig_v4_f96_dual_docking_node23_waiter_v1_1.sh.in"
TEST=SRC/"test_build_phase2_v4_f96_dual_docking_package_v1_1.py"
DEFAULT_OUT=EXP/"prepared/pvrig_v4_f96_dual_docking_v1_1"
DEFAULT_FREEZE=EXP/"audits/phase2_v4_f96_dual_docking_v1_1_implementation_freeze.json"
EXPECTED={
...
def build(out:Path,freeze_path:Path)->dict[str,Any]:
 ...
 freeze={"schema_version":"phase2_v4_f96_dual_docking_v1_1_implementation_freeze","status":"FROZEN_BEFORE_ANY_V4_F96_DOCKING_LABEL_GENERATION","frozen_at_utc":now(),"implementation_hashes":implementation,"bound_formal_hashes":EXPECTED,"supersedes_v1_deployment":{"remote_root":"/data/qlyu/projects/pvrig_v4_f96_dual_redocking_v1_20260717","bootstrap_pid":2056197,"terminal":True,"failure":"readonly ROOT status environment collision","scientific_work_started":False,"docking_jobs_started":0,"label_receipt_produced":False,"formal_evaluator_run":False},"current_expected_hard_pass_count":0,"zero_eligible_contract":{"canonical_receipt_path":ZERO_ELIGIBILITY_PATH,"canonical_receipt_sha256":ZERO_ELIGIBILITY_SHA,"status":"NO_ELIGIBLE_DOCKING","docking_jobs":0,"label_receipt":False,"formal_evaluator_run":False,"threshold_change":False,"trimming":False,"replacement":False},"future_nonzero_contract":{"prediction_v3_exact_gate":True,"full_qc_exact_gate":True,"all_hard_pass":True,"receptors":["8X6B","9E6Y"],"seeds":[917,1931,3253],"fixed_top8":True,"minimum_successful_seeds_per_receptor":2,"no_replacement":True},"claim_boundary":CLAIM}
 ...
 atomic(out/"PACKAGE_RECEIPT.json",{"schema_version":"phase2_v4_f96_dual_docking_v1_1_package_receipt","status":"PASS_PACKAGE_FROZEN_LABEL_BLIND","created_at_utc":now(),"files":files,"label_paths_read":0,"scientific_work_started":False,"current_expected_terminal":"NO_ELIGIBLE_DOCKING","claim_boundary":CLAIM})
