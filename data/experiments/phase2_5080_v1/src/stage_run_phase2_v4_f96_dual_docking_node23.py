...
INPUT_ROOT = Path("/data/qlyu/projects/pvrig_v4_f96_docking_input_release_v1_20260717")
ROOT = Path("/data/qlyu/projects/pvrig_v4_f96_dual_redocking_v1_20260717")
PYTHON = Path("/data/qlyu/anaconda3/envs/haddock3/bin/python")
HADDOCK3 = Path("/data/qlyu/anaconda3/envs/haddock3/bin/haddock3")
SCRATCH = Path("/tmp/pvrig_v4f96_dual_redocking_v1")
SEEDS = (917, 1931, 3253)
CONFORMATIONS = ("8x6b", "9e6y")
SUCCESS_STATES = {"SUCCESS", "PASS", "PASSED", "COMPLETE", "COMPLETED", "DONE"}
PROTOCOL_ID = "pvrig_v4_f96_independent_dual_redocking_v1_20260717"
EXPECTED_SOURCE = {
