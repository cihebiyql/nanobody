...
SCRIPT = Path(__file__).with_name("monitor_phase2_v4_d_surrogate_training.sh")
HELPER = Path(__file__).with_name("phase2_v4_d_surrogate_watcher_helper.py")
TRAIN = "OPEN_TRAIN"
...
class Fixture:
    ...
    def state(self) -> dict[str, object]:
        path = self.exp / "status/pvrig_v4_d_surrogate_training_v1/status.json"
