...
CANONICAL_RECOVERY_ROOT = Path(
    "/data1/qlyu/projects/pvrig_v4_h_qc96_h2_h4_recovery_v1_2_20260717"
)
CLAIM = (
...
EXPECTED_H1_SOURCE_FIELDS = [
    "raw_candidate_id", "sequence", "sequence_sha256", "sequence_length", "parent_id",
    "parent_framework_cluster", "parent_queue_rank", "parent_sequence_sha256",
    "target_patch_id", "design_mode", "design_task_id", "design_loops", "designed_regions",
    "hotspots_pdb", "hotspots_uniprot", "backbone_index", "mpnn_index",
    "rfdiffusion_design_index", "proteinmpnn_deterministic_seed_contract", "cdr1_before",
    "cdr2_before", "cdr3_before", "cdr1_after", "cdr2_after", "cdr3_after",
    "designed_region_edit_present", "cdr3_length", "source_backbone_pdb_sha256",
    "source_sequence_pdb_sha256", "claim_boundary", "h1_selection_hash",
    "h1_selection_rank_in_stratum", "candidate_id",
]
...
def validate_h1_source_header(fields: Sequence[str]) -> None:
    if list(fields) != EXPECTED_H1_SOURCE_FIELDS:
        raise RuntimeError("h1_source_header_mismatch")
...
class Recovery:
    ...
    def validate(self) -> dict[str, Any]:
        ...
        validate_h1_source_header(source_fields)
    ...
    def run(self) -> dict[str, Any]:
        ...
        provenance_fields = list(context["source_fields"])
        provenance_rows = project_rows(
            [source_by[row["candidate_id"]] for row in selected], provenance_fields
        )
        provenance_path = self.recovery / "qc96_selected_source_provenance_v1.tsv"
        atomic_tsv(provenance_path, provenance_rows, provenance_fields)
        ...
        for row in provenance_replay:
            ...
            if any(row[field] != original[field] for field in provenance_fields):
        ...
        audit = {
            "schema_version": "phase2_v4_h_qc96_h2_h4_manifest_recovery_audit_v1_2",
            "status": "PASS_V4_H_QC96_FROZEN_AFTER_LABEL_FREE_FULL_QC",
            "recovery_status": "PASS_V4_H_QC96_H4_MANIFEST_RECOVERED",
            "recovery_scope": (
                "H4_CORE_MANIFEST_EXPLICIT_PROJECTION_PLUS_EXACT_ORIGINAL_SOURCE_PROVENANCE_SIDECAR_ONLY"
            ),
            "source_root": str(self.source),
            "supersedes_v1_1_partial_publication_failure_receipt_sha256": (
                "0f5388ca7ad89b71fc359a5dd1e3ef7ba3d4edb14abeb4e73135af9f02be335d"
            ),
            ...
            "provenance_sidecar_exact_original_source_schema": True,
            "provenance_sidecar_selection_metadata_added": False,
        ...
        receipt = {
            **audit,
            "schema_version": "phase2_v4_h_qc96_h2_h4_manifest_recovery_receipt_v1_2",
        ...
        complete = {
            "schema_version": "phase2_v4_h_qc96_h2_h4_manifest_recovery_terminal_v1_2",
...
def main() -> int:
    ...
    if args.preflight:
        ...
        result = {
            "status": "PASS_V4_H_H2_H4_RECOVERY_V1_2_PREFLIGHT",
