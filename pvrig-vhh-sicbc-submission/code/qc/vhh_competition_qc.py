    ...
    *,
    ...
    for candidate in candidates:
        ...
        row = {
            ...
            "AbNatiV_FR_VHH_score": candidate.get("abnativ_fr_vhh_score", ""),
            "Sapiens_mean_self_probability": candidate.get("sapiens_mean_self_probability", ""),
            "Sapiens_num_suggested_mutations": candidate.get("sapiens_num_suggested_mutations", ""),
