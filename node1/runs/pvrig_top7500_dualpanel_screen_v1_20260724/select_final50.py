#!/usr/bin/env python3
"""Freeze the final50 and Top10 diversity-constrained submission portfolio."""
...
def main() -> int:
    ...
    def add(row: dict[str, str], channel: str) -> None:
        ...
        copied["final_selection_reason"] = (
            "all required hard gates complete; selected by calibrated "
            "binding/blocking rank under final diversity constraints"
        )
    ...
    receipt = {
        "schema_version": "pvrig.final50.portfolio.v1",
        ...
        "claim_boundary": (
            "Computational portfolio; no experimental BLI, Kd, IC50, expression "
            "or purity claim."
        ),
    }
