...
> 生成时间：`2026-07-14T00:42:58.826895+00:00`
...
如果 100 条富集子集的历史比例完全复现，1,024 条 docking 可得到约 `205` 条任一 A、`174` 条严格 good。这个数字只能作为容量规划上限，不是 prospective 产量承诺；当前没有经过未来批次校准的可信预测区间，应先用 512 条 docking pilot 实测新分布。
