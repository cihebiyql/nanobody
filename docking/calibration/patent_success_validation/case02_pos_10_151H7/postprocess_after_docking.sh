...
python "$ROOT/docking/success_case_validation/apply_blocker_judgment.py" \
  ...
  --candidate-name case02_pos_10_151H7_8x6b \
  --format-context naked_vhh \
  --out-csv "$WD/reports/case02_pos_10_151H7_8x6b_blocker_classification.csv" \
  --out-md "$WD/reports/case02_pos_10_151H7_8x6b_blocker_classification.md"
