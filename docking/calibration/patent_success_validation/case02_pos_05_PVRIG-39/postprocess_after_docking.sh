...
python "$ROOT/docking/success_case_validation/apply_blocker_judgment.py" \
  ...
  --candidate-name case02_pos_05_PVRIG-39_8x6b \
  --format-context naked_vhh \
  --out-csv "$WD/reports/case02_pos_05_PVRIG-39_8x6b_blocker_classification.csv" \
  --out-md "$WD/reports/case02_pos_05_PVRIG-39_8x6b_blocker_classification.md"
...
#   --cdr1 26-33 --cdr2 51-57 --cdr3 96-109 \
