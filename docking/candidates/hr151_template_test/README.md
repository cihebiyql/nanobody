...
- `inputs/hr151_template_test_vhh.fasta`
- `haddock3/hr151_template_test_pvrig_hotspot_test.cfg`
- `haddock3/data/hr151_template_test_cdr_to_pvrig_hotspot_ambig.tbl`
